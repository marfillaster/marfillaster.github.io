...
- `.codex/skills/update-solar-report-site/scripts/update_site.py` regenerates the three outputs above from the report markdown.
- `.codex/skills/update-solar-report-site/scripts/generate_og_image.py` renders the OG image (called by `update_site.py`).
