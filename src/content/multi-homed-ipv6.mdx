...
I used was [NoPtk](https://noptk.com/) for both the ASN and the `/48`
...
- [NoPtk](https://noptk.com/) — the LIR I used for the ASN and `/48`
...
*Disclosure: the pdxnet.co.uk link above is an affiliate link — signing
up through it earns me a referral credit at no extra cost to you. I am
recommending the provider because I use it on this build, not because
of the credit.*
