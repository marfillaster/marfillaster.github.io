...
I used was [NoPkt](https://store.nopkt.com?ref=PmEDMa2Qum)
(affiliate link) for both the ASN and the `/48`
(`$20` one-time + `$60/year` USD), and
[pdxnet.co.uk / getvps.net](https://my.pdxnet.co.uk/aff.php?aff=5)
(AS&nbsp;52025, affiliate link) for the transit VPS — `$6/month`
...
- [NoPkt](https://store.nopkt.com?ref=PmEDMa2Qum) (affiliate link) — the LIR I used for the ASN and `/48`
- [pdxnet.co.uk / getvps.net](https://my.pdxnet.co.uk/aff.php?aff=5) (AS&nbsp;52025, affiliate link) — the transit VPS I used, $6/month with a free self-service BGP session
