...
seo:
  ogImage: "https://blog.homestack.space/mikrotik-home-network/og.png"
  ogImageAlt: "A small home network behind CGNAT — RB5009 series index"
hero:
...
([here](/mikrotik-ipv6-failover-bgp-bfd/), VPS path only). A separate build
replaces the Converge ONT with a GPON SFP stick in the RB5009's SFP+ cage
([here](/converge-gpon-sfp-stick-mikrotik/)). References point
...
- [Replacing a Converge ONT with a GPON SFP stick on the RB5009 — companion build](/converge-gpon-sfp-stick-mikrotik/)
