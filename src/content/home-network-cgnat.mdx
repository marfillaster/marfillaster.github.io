...
- **[Routed IPv6 over CGNAT via a VPS](/vps-ipv6-cgnat-mikrotik/)** — a
  ...
  includes Ubuntu/BIRD and VyOS relay variants.
...
| **Failover companion**  | [BGP+BFD post](/mikrotik-ipv6-failover-bgp-bfd/) layers on the BGP session, with Ubuntu/BIRD and VyOS variants | n/a — single uplink, fast fail-to-IPv4 inside the post |
