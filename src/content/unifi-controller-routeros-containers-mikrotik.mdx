...
[RB5009 CGNAT series](/mikrotik-home-network/). That series builds a
segmented home LAN on a single MikroTik RB5009. This post runs the
**UniFi Network Application and its MongoDB on the router itself**, as two
