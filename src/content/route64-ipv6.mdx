...
```bash title="Home router — Route64 WireGuard client"
...
```bash title="Home router — Route64 default route"
...
```bash title="Home router — netwatch arms/disarms the IPv6 uplink"
...
```bash title="Home router — Route64 DynDNS scheduler"
