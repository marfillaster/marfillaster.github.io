...
> **Updated July 21, 2026:** the loan is now settled — the Pag-IBIG check paid off
> BDO in full. This chronicle runs through payoff. The steps that remain — mortgage
> cancellation, the excess and retention refunds, and the unused-insurance refunds —
> are in the epilogue and will be updated as they land.
...
Payoff is not quite the end of the file. As of July 21, 2026 the loan is settled,
and these steps remain — in the order the closing call spelled out:

- **Excess refund (~₱27,897.61).** BDO applied the whole check, so the
  overpayment above the payoff comes back as a refund. The payment posts about two
  banking days after settlement; the refund is then requested as its own case.
- **Loan cancellation and the collateral documents.** BDO closes the loan in about
  ten banking days and notifies by email. Then Pag-IBIG — not the borrower —
  retrieves the Cancellation/Release of Mortgage and the owner's copy of the title
  from the bank. One requirement surfaced only on the closing call, and Pag-IBIG
  had not mentioned it: for anyone but me to collect those documents, BDO needs an
  authorization letter, a copy of my ID, and the name and ID of the Pag-IBIG
  representative receiving them. Prepared in advance.
...
- **Retention refund (₱82,952.38).** Last in the chain — requestable by email only
  after that completion notice, once the annotation is cleared. No timeline was
  given for the Pag-IBIG side.
- **Unused-insurance refunds.** BDO's life (MRI) and fire premiums were both
  prepaid for the year running to late January 2027; pre-terminating mid-year
  should return the unearned portion. The cancellation and refund requests went
  out the day of settlement. The fire side is time-critical — its short-period
  endorsement returns only a quarter of the net premium within six months of
  inception and nothing after, a hard cutoff six days past settlement — but it is
  a small sum. The life refund is the larger and better-supported claim, resting
  on a written commitment from the insurer to refund it. Three refunds in all,
  from three payers on three timelines: the loan excess from BDO, the life premium
  from BDO Life, the fire premium from Prudential Guarantee.
- **First payment:** ₱18,523.66 on August 10, 2026, then every 10th for 240
  months; the first billing statement confirmed the figure.
...
driving. What's left is paperwork and money coming back — the cancellation and
the refunds. This chronicle will be updated as those land.
