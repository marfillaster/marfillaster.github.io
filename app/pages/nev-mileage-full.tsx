// Port of src/routes/nev-mileage-full.tsx. The report body renders at request
// time from src/content/nev-full-report.md via the shared renderer.
...
export const nevMileageFullDescriptors: MetaDescriptor[] = [
  { title },
  ...
  { "script:ld+json": structuredData },
  {
    "script:ld+json": breadcrumbList([
      ...
      { name: "Full report", item: "https://blog.homestack.space/nev-mileage/full-report" },
    ]),
  },
];
...
export function NevMileageFullPage(handle: Handle<{ html: string }>) {
  return () => (
    <SiteShell>
