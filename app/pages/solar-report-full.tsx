// Port of src/routes/solar-report-full.tsx. Body renders at request time from
// src/content/full-report.md via the shared renderer.
...
const title =
  "Full residential solar performance report — Cavite, Philippines (Dec 2025–Aug 2026)";
const description =
  "Full report: hourly-data-driven analysis of a 6.5 kWp / 14.3 kWh / 8 kW residential solar+battery system in Cavite, Philippines, covering nine months from December 2025 to August 2026. Generation, self-sufficiency, recommendations, bill impact, ROI, battery health, projections, and methodology.";
...
export const solarReportFullDescriptors: MetaDescriptor[] = [
  { title },
...
export function SolarReportFullPage(handle: Handle<{ html: string }>) {
  return () => (
    <SiteShell>
      <div className="container max-w-[48rem] py-12 leading-relaxed">
        <article>
          <p className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">
            Full report · 6.5 kWp · Cavite, PH · Dec 2025 – Aug 2026
          </p>
        ...
        <article className="typeset typeset-post" innerHTML={handle.props.html} />
      </div>
    </SiteShell>
  );
}
